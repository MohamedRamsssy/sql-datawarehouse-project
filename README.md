...
*   **🥇 Gold Layer:** Business-level aggregations and advanced analytical queries.

The database schema and entity relationships were fully conceptualized and logically modeled using **Draw.io**. *(See the `docs` folder for the ER diagram).*

## 🛠️ Tech Stack
*   **Database Engine:** SQL Server 
*   **Data Modeling:** Draw.io
*   **Core Concepts:** Advanced SQL, Window Functions, Subqueries, ETL Processes.
